...
const server=fs.readFileSync(new URL("../src/server.js",import.meta.url),"utf8")+fs.readFileSync(new URL("../src/productionMapIntegration.js",import.meta.url),"utf8");
...
for(const password of ["TEST_ONLY_2#/","TEST_ONLY_1*","TEST_ONLY_3#","*TEST_ONLY_4*"])test("synthetic password string preserved",()=>{
